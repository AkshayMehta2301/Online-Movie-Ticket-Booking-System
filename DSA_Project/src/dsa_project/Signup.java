...
public class Signup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dsa_project/icons8_login_rounded_right_25px.png"))); // NOI18N
    ...
    private void jLabel14MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel14MouseClicked
        ...
        //System.out.println("375 In try Block"+fname);
        ...
        try {
            ...
            //ps.setString(2, pass);
            //System.out.println("382 In try Block"+fname);
            rs=ps.executeQuery();
            ...
            if(rs.next()){
                ...
                else if(num.equals(""))
                {
                    ...
                    JOptionPane.showMessageDialog(null, "Both Password Not Matching.");
                }
                else if(pass.equals(Repass)){
                    //PreparedStatement ps;
                    String query = "INSERT INTO login_details(First_Name,Last_Name,Email,Contact_No,password) VALUES (?,?,?,?,?)";

                    try {
                        ps = DB_Connect.getConnection().prepareStatement(query);
                        //System.out.println("410 In try Block"+fname);
        ...
        try {
            ...
            message.setText("Dear User,"+"\n"+
                    ...
                    "Your OTP is "+OP+"\n"+"Please verify your email address to complete your registration."+"\n\n\n"+"For any queries or clarifications, please contact us at akshaymehta555@gmail.com\n" +
"\n" +
...
"Please do not reply to this email");
            ...
            System.out.println("After Message sent in SignUP 486");
